...
Field::Coordinates Field::GetPos() // Возвращаем текущее положение курсора.
{
...
{
    int8_t value = m_playground[GetIndex(m_coordinates.x,m_coordinates.y)];
    m_playground[GetIndex(m_coordinates.x,m_coordinates.y)] = 0;
    return value;
}